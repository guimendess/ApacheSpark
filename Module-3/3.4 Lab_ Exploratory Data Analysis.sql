...
-- TODO
select count (*) from outdoorProducts
where
quantity < 0;
...
--TODO
select alpha3code a, totalQuantity b
from
countryCodes a 
inner join salesQuants b on 
a.EnglishShortName = b.countryName
